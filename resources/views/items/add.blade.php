...
<form class="forms-sample" action="{{route('items.create')}}" method="post" >
@csrf

<div class="form-group">
<label for="exampleInputName1">Description</label>
<input type="text" name="description" class="form-control" id="exampleInputName1" value="" placeholder="Description" required>
</div>
...
<input type="text" name="currency" class="form-control" id="exampleInputName1" value="" placeholder="currency " required>
</div>

<div class="form-group">
<label for="exampleInputName1">Conversion Rate</label>
<input type="number" name="conversion_rate" class="form-control" id="exampleInputName1" value="" placeholder="conversion rate" required>
</div>
